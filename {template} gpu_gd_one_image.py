# script for gd/sam for zero shot seg for ONE IMAGE

# main changes from cpu_gd_one_image.py:
    # update line 18: sys.path.append
    # comment out line 27: "device = torch.device('cpu')""
    # update line 31: config_path
    # update line 33: checkpoint_path
    # comment out line 35: to(device) portion
    # update line 37: IMAGE_PATH 
    # comment out line 55: device = "cpu" in predict function
